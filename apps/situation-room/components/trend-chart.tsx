...
export function TrendChart({ data, metricIndex }: TrendChartProps) {
  ...
  const options = useMemo(() => ({
    ...
    plugins: {
      ...
      tooltip: {
        ...
        padding: 12,
        cornerRadius: 8,
        titleFont: { size: 12, weight: "bold" as const, family: "Inter, sans-serif" },
    ...
    scales: {
      x: {
        grid: { display: false },
        ticks: { font: { size: 11, family: "Inter, sans-serif" }, color: textTertiary || "#9ca3af" },
  ...
  }), [textSecondary, textTertiary, textPrimary, surfaceElevated, border, borderSubtle]);
