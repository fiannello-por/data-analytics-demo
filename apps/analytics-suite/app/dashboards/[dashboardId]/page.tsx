      ...
      <section className="grid gap-6 xl:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
        <Card>
          <CardHeader>
            ...
            <CardTitle className="text-2xl">Dashboard-local semantic registry</CardTitle>
        ...
        <aside className="space-y-4">
          <Card>
            ...
            <CardContent>
              ...
              <div>
                <dt className="font-medium text-muted-foreground">Dashboard ID</dt>
                <dd>{module.id}</dd>
              </div>
              <div>
              ...
              <div>
                <dt className="font-medium text-muted-foreground">Semantic models</dt>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div>
                <dt className="font-medium text-muted-foreground">Max queries per load</dt>
                <dd>{module.budgetPolicy.maxQueryCount}</dd>
              </div>
              <div>
                <dt className="font-medium text-muted-foreground">Target bytes</dt>
                <dd>{module.budgetPolicy.targetBytesProcessed.toLocaleString()}</dd>
              </div>
              <div>
                <dt className="font-medium text-muted-foreground">Target execution</dt>
                <dd>{module.budgetPolicy.targetExecutionDurationMs} ms</dd>
              </div>
              <div>
                <dt className="font-medium text-muted-foreground">Warning ratio</dt>
